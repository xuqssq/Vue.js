...
const { VueLoaderPlugin } = require('vue-loader') //配置（注意：vue-loader15版本以后需要配置VueLoadPlugin）
...
module.exports = {
    ...
    plugins: [ //配置插件的节点，启动热更新第三步
        ...
        new VueLoaderPlugin() //配置（注意：vue-loader15版本以后需要配置VueLoadPlugin）
    ],
    module: { //这个节点用于配置所有第三方模块加载器
        rules: [ //所有第三方模块的匹配规则
            ...
            { test: /\.vue$/, use: 'vue-loader' } //这是处理 .vue 的loader
        ]
    },
    resolve: {
